...
/** Session list exercise card preview — portrait frame matches Male Slider Photos. */
export const SESSION_EXERCISE_CARD_PREVIEW_WIDTH = 300;
export const SESSION_EXERCISE_CARD_PREVIEW_HEIGHT = Math.round(
  SESSION_EXERCISE_CARD_PREVIEW_WIDTH * (EXERCISE_VIDEO_FRAME_HEIGHT / EXERCISE_VIDEO_FRAME_WIDTH),
);
